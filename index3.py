...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def loadImage(self, inputdir):
        ...
        for member in plans:
            ...
            image[k] = (image[k]-min) / (float(max)-min) * 255
    ...
    def paintGL(self):
        ...
        glTexCoord2f(0.0, 0.0);        glVertex2f(lim3[0]-2*w,h-lim3[1]);
        glTexCoord2f(0.0, 1.0);        glVertex2f(lim3[2]-2*w,h-lim3[1]);
        glTexCoord2f(1.0, 1.0);        glVertex2f(lim3[2]-2*w,h-lim3[3]);
        glTexCoord2f(1.0, 0.0);        glVertex2f(lim3[0]-2*w,h-lim3[3]);
    ...
    def mousePressEvent(self, event):
        ...
        if self.x * self.scaleIndex < W and self.y * self.scaleIndex < H:
            ...
            x0 = int((self.x * self.scaleIndex) * len(image3) / float(H));
            pointer = 3
        if self.x * self.scaleIndex > W and self.y * self.scaleIndex > H:
