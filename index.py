...
class Ui_Form(QtGui.QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        self.L.setText(_translate("Form", 'L', None))
        ...
        with open('LUT.csv', 'rb') as csvfile:
            ...
            for row in spamreader:
                if(row[0]==''):
                    shift+=0.5
                    continue
                lootScheme[int(row[0])][int(shift)]=int(row[1])
...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def paintGL(self):
        ...
        glTexCoord2f(0.0, 0.0);        glVertex2f(lim3[2]-w,h-lim3[1]);
        glTexCoord2f(0.0, 1.0);        glVertex2f(lim3[0]-w,h-lim3[1]);
        glTexCoord2f(1.0, 1.0);        glVertex2f(lim3[0]-w,h-lim3[3]);
    ...
    def drawText(self):
        ...
        self.renderText(W / 2, H - 20, 0, window.t21)
        self.renderText(0+10, H/2, 0, window.t31)
    ...
    def drawMaskLoot(self):
        ...
        glTexCoord2f(1.0, 0.0);        glVertex2f(0, h);
        glTexCoord2f(1.0, 1.0);        glVertex2f(0, 0);
        glTexCoord2f(0.0, 1.0);        glVertex2f(-w, 0);
        glEnd();
...
class MyDynamicMplCanvas(MyMplCanvas):
    ...
    def update_figure(self,rect):
        ...
        for i in rawMask1:
            ...
            if(lootScheme[pixel][1]<lootScheme[pixel][2] and lootScheme[pixel][1]<lootScheme[pixel][3]):
        ...
        count = int(math.floor(1+3.332*math.log10(len(subImage))))
